			...
			<div class="main_container" id="main">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<h4 style="color: #08899c;">Add new patient form</h4>
					</div>
				</div>

				<div class="card">
				    <div class="card-body login-card-body">
						<h3>REGISTER A NEW PATIENT FORM</h3>

				      	<form action="handler/add-patient-handler.php" method="post">
							...
							<div class="row">
					      		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						    		<div class="form-group">
									    <!-- <label>patient Role:</label> -->
									    <input type="hidden" name="role" class="form-control" value="Patient" readonly="">
								  	</div>
								</div>
							</div>
							...
							<div class="row">
					      		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						    		<div class="form-group">
									    ...
									    <select class="form-control" name="status">
										    ...
										    <option value="Marriage" name="Marriage">Marriage</option>
										</select>
								  	</div>
								</div>
							  	...
							  	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						    		<div class="form-group">
									    ...
									    <input type="text" name="problemType" class="form-control" placeholder="problem type...">
								  	</div>
								</div>
							</div>
